...
public abstract class WaterCamoItem extends ArmorItem {
    public WaterCamoItem(Type type, Properties properties) {
    ...
    public static class Boots extends WaterCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/water_layer_1.png";
        }
    }
    ...
    public static class Leggings extends WaterCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/water_layer_2.png";
        }
    }
