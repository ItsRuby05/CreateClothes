...
public abstract class SnowCamoItem extends ArmorItem {
    public SnowCamoItem(Type type, Properties properties) {
    ...
    public static class Boots extends SnowCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/snow_layer_1.png";
        }
    }
    ...
    public static class Leggings extends SnowCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/snow_layer_2.png";
        }
    }
