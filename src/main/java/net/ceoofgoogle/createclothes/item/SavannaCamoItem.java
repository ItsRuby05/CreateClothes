...
public abstract class SavannaCamoItem extends ArmorItem {
    public SavannaCamoItem(Type type, Properties properties) {
    ...
    public static class Boots extends SavannaCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/savanna_layer_1.png";
        }
    }
    ...
    public static class Leggings extends SavannaCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/savanna_layer_2.png";
        }
    }
