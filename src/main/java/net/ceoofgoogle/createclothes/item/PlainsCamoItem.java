...
public abstract class PlainsCamoItem extends ArmorItem {
    public PlainsCamoItem(ArmorItem.Type type, Item.Properties properties) {
    ...
    public static class Boots extends net.ceoofgoogle.createclothes.item.PlainsCamoItem {
        public Boots() {
            super(Type.BOOTS, new Item.Properties());
        }

        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/plains_layer_1.png";
        }
    }

    public static class Leggings extends net.ceoofgoogle.createclothes.item.PlainsCamoItem {
        public Leggings() {
            super(Type.LEGGINGS, new Item.Properties());
        }

        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/plains_layer_2.png";
        }
    }

    public static class Chestplate extends net.ceoofgoogle.createclothes.item.PlainsCamoItem {
        public Chestplate() {
    ...
    public static class Helmet extends net.ceoofgoogle.createclothes.item.PlainsCamoItem {
        public Helmet() {
