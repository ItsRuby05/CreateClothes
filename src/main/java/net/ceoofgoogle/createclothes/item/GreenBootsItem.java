...
public abstract class GreenBootsItem extends ArmorItem {
    public GreenBootsItem(Type type, Properties properties) {
    ...
    public static class Boots extends DesertCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/green_boots.png";
        }
    }
}