...
public abstract class RedcoatItem extends ArmorItem {
    public RedcoatItem(Type type, Properties properties) {
        super(new ArmorMaterial() {
            ...
            public int getDefenseForType(Type type) {
                return (new int[]{2, 3, 6, 4})[type.getSlot().getIndex()];
            }
    ...
    public static class Chestplate extends RedcoatItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/redcoat.png";
        }
    }
}