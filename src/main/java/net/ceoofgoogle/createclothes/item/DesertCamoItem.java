...
public abstract class DesertCamoItem extends ArmorItem {
    public DesertCamoItem(Type type, Properties properties) {
    ...
    public static class Boots extends DesertCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/desert_layer_1.png";
        }
    }
    ...
    public static class Leggings extends DesertCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/desert_layer_2.png";
        }
    }
