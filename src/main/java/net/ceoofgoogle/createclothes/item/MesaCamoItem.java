...
public abstract class MesaCamoItem extends ArmorItem {
    public MesaCamoItem(Type type, Properties properties) {
    ...
    public static class Boots extends MesaCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/mesa_layer_1.png";
        }
    }
    ...
    public static class Leggings extends MesaCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/mesa_layer_2.png";
        }
    }
