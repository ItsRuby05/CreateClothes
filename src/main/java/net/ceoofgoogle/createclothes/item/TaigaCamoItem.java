...
public abstract class TaigaCamoItem extends ArmorItem {
    public TaigaCamoItem(Type type, Properties properties) {
    ...
    public static class Boots extends TaigaCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/taiga_layer_1.png";
        }
    }
    ...
    public static class Leggings extends TaigaCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/taiga_layer_2.png";
        }
    }
