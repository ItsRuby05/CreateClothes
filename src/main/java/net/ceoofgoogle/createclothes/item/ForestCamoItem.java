...
public abstract class ForestCamoItem extends ArmorItem {
    public ForestCamoItem(Type type, Properties properties) {
    ...
    public static class Boots extends ForestCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/forest_layer_1.png";
        }
    }
    ...
    public static class Leggings extends ForestCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/forest_layer_2.png";
        }
    }
