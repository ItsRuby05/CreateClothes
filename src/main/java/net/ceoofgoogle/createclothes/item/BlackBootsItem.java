...
public abstract class BlackBootsItem extends ArmorItem {
    public BlackBootsItem(Type type, Properties properties) {
    ...
    public static class Boots extends DesertCamoItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "createclothes:textures/models/armor/black_boots.png";
        }
    }
}